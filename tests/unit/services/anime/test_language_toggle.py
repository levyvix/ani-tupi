...
from services.anime.search_service import IncrementalSearchState, incremental_search_anime
...
class TestIncrementalSearchAnimeLanguageTracking:
    ...
    @patch("services.anime.search_service.rep")
    @patch("services.anime.search_service.ui_bridge.loading")
